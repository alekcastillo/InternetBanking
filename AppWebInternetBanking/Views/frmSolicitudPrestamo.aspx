<%@ Page Async="true" MasterPageFile="~/Site.Master" Language="C#" AutoEventWireup="true" CodeBehind="frmSolicitudPrestamo.aspx.cs" Inherits="AppWebInternetBanking.Views.frmSolicitudPrestamo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1>Mantenimiento de solicitud de prestamos</h1>
    <input id="myInput" placeholder="Buscar" class="form-control" type="text" />
    <asp:GridView ID="gvSolicitudPrestamos" runat="server" AutoGenerateColumns="false"
      CssClass="table table-sm" HeaderStyle-CssClass="thead-dark" 
        HeaderStyle-BackColor="#243054" HeaderStyle-ForeColor="White" 
        AlternatingRowStyle-BackColor="LightBlue" OnRowCommand="gvSolicitudPrestamos_RowCommand" >
        <Columns>
            ...
            <asp:BoundField HeaderText="Profesión" DataField="Profesion" />
            <asp:BoundField HeaderText="Ingreso Mensual" DataField="IngresoMensual" />
            <asp:BoundField HeaderText="Destino Prestamo" DataField="DestinoPrestamo" />
            <asp:BoundField HeaderText="Monto Deseado" DataField="MontoDeseado" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <table style="width: 100%;">
              ...
              <tr>
                  <td><asp:Literal ID="ltrProfesion" Text="Profesión" runat="server" /></td>
                  <td><asp:TextBox ID="txtProfesion" runat="server" CssClass="form-control" /></td>
              </tr>
              <tr>
                  <td><asp:Literal ID="ltrIngresoMensual" Text="Ingreso Mensual" runat="server" /></td>
                  <td><asp:TextBox ID="txtIngresoMensual" TextMode="Number" runat="server" CssClass="form-control" onkeypress="return isNumberKey(event)" /></td>
              </tr>
              <tr>
                  <td><asp:Literal Text="Destino Prestamo" runat="server" /></td>
                  <td> <asp:DropDownList ID="ddlDestinoPrestamo"  CssClass="form-control" runat="server">
                    <asp:ListItem Value="Personal">Personal</asp:ListItem>
                    <asp:ListItem Value="Casa">Casa</asp:ListItem>
                    <asp:ListItem Value="Vehículo">Vehículo</asp:ListItem>
                </asp:DropDownList></td>
              </tr>
              <tr>
                  <td><asp:Literal ID="ltrMontoDeseado" Text="Monto Deseado" runat="server" /></td>
                  <td><asp:TextBox ID="txtMontoDeseado" TextMode="Number" runat="server" CssClass="form-control" onkeypress="return isNumberKey(event)" /></td>
              </tr>
          </table>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Mantenimiento de solicitudes de prestamos</h4>
      </div>
      <div class="modal-body">
