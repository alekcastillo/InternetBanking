...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gvprestamo" runat="server" AutoGenerateColumns="false"
      CssClass="table table-sm" HeaderStyle-CssClass="thead-dark" 
        ...
        AlternatingRowStyle-BackColor="LightBlue" OnRowCommand="gvPrestamo_RowCommand" >
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="Intereses" DataField="Intereses" />
      ...
      <div class="modal-body">
          <table style="width: 100%;">
              ...
              <tr>
                  ...
                  <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtMonto" runat="server" ErrorMessage="Solo se admiten numeros en el espacio de Monto" ValidationExpression="^[1-9][\.\d]*(,\d+)?$">
                       </asp:RegularExpressionValidator>
              </tr>
              <tr>
                  <td><asp:Literal ID="ltrIntereses" Text="Intereses" runat="server" /></td>
                  <td><asp:TextBox ID="txtIntereses" TextMode="Number" runat="server" CssClass="form-control" /></td>
                  <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ControlToValidate="txtIntereses" runat="server" ErrorMessage="Solo se admiten numeros en el espacio de Intereses" ValidationExpression="^[1-9][\.\d]*(,\d+)?$">
                       </asp:RegularExpressionValidator>
              </tr>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Mantenimiento de Prestamo</h4>
      </div>
      <div class="modal-body">
