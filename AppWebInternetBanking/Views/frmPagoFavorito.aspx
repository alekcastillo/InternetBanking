<%@ Page Async="true" MasterPageFile="~/Site.Master" Language="C#" AutoEventWireup="true" CodeBehind="frmPagoFavorito.aspx.cs" Inherits="AppWebInternetBanking.Views.frmPagoFavorito" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1>Mantenimiento de pagos favoritos</h1>
    <input id="myInput" placeholder="Buscar" class="form-control" type="text" />
    <asp:GridView ID="gvPagoFavoritos" runat="server" AutoGenerateColumns="false"
      CssClass="table table-sm" HeaderStyle-CssClass="thead-dark" 
        HeaderStyle-BackColor="#243054" HeaderStyle-ForeColor="White" 
        AlternatingRowStyle-BackColor="LightBlue" OnRowCommand="gvPagoFavoritos_RowCommand" >
        <Columns>
      ...
      <div class="modal-body">
          <table style="width: 100%;">
              ...
              <tr>
                  ...
                  <td><asp:TextBox ID="txtIBAN" runat="server" Enabled="true" CssClass="form-control" /></td>
              </tr>
          </table>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Mantenimiento de pagos favoritos</h4>
      </div>
      <div class="modal-body">
